...
from src.engine import Fastener, KnowledgeBase, Question, Rule, SuggestionRule
...
class TestKnowledgeBaseLoading:
    ...
    def test_correct_counts(self, kb):
        ...
        assert len(kb.questions) == 11
        assert len(kb.fasteners) == 54
...
class TestKnowledgeBaseSaving:
    ...
    def test_save_preserves_fastener_data(self, kb):
        ...
        try:
            ...
            assert (
                f1.properties.compatible_materials == f2.properties.compatible_materials
            )
