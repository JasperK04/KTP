...
AGENT_C_SCENARIOS = [
    ...
    TestScenario(
        ...
        expected_categories=[],
        excluded_categories=[],
        expected_fasteners=["Dowel pin", "metal welding", "Two-component epoxy"],
...
ALL_SCENARIOS = (
    AGENT_A_SCENARIOS + AGENT_B_SCENARIOS + AGENT_C_SCENARIOS + AGENT_D_SCENARIOS
)
